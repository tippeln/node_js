  ...
  up: async (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('t_error', [
      ...
      },
      {
        ...
        row_no: 2, 
        col_no: 2, 
        naiyo: 'カラム数が違います。正しいカラム数：4,現在のカラム数:128',
        rel_col_no: 2, 
        biko: '備考欄です。2222222222222',
        last_upd_datetime:new Date(),
        last_upd_user_no: 2,
        createdAt: new Date(),
        updatedAt: new Date()        
      },
      {
        ...
        row_no: 3, 
        col_no: 3, 
        naiyo: 'カラム数が違います。正しいカラム数：4365,現在のカラム数:1564',
        rel_col_no: 3, 
        biko: '備考欄です。333333333333',
        last_upd_datetime:new Date(),
        last_upd_user_no: 3,
        createdAt: new Date(),
        updatedAt: new Date()        
